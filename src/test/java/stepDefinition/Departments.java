...
public class Departments extends Rootclass {
	...
	public void user_enters_the_department_name(String value) throws InterruptedException {
		...
		Departments.departmentName.sendKeys(DepartmentName);
	...
	public void user_verifies_the_presence_of_the_name_in_the_table(String value) {
		driver.findElement(By.xpath("//table//tbody/tr/td[contains(text(),'"+DepartmentName+"')]"));
	}
	
	@Then("User updates the {string} in the table")
	public void user_updates_the_department_name_in_the_table(String string) {
	   driver.findElement(By.xpath("//td[normalize-space()='"+DepartmentName+"']//following::td//a[contains(text(),'Edit')]")).click();
	   Departments.departmentName.click();
	   Departments.departmentName.sendKeys("_UPDATED");
	   Departments.saveButton.click();
	   System.out.println("DEBUG : Updated Department name is "+DepartmentName+"_UPDATED");
	}
	
	@Then("User deletes the {string} in the table")
	public void user_deletes_the_department_name_in_the_table(String string) {
		List<WebElement> rows = driver.findElements(By.xpath("//table//tr"));
		act.getTheListOfStringFromFindElements("table");
